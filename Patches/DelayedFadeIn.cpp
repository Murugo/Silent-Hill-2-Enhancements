...
// Patch fade-in transition to hold for a short duration before fading in the screen
void PatchDelayedFadeIn(float Seconds)
{
    FadeInStartValue = -Seconds;
