...
// Fixes the volume of the sound that plays in the elevator leading to the labyrinth. This patch adjusts the delta time
// calculation used to fade the sound in order to avoid hitching, and allows the sound to play at full volume.
